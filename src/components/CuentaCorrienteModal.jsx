...
export default function CuentaCorrienteModal({ clienteId, clientesCC, onClose, onPagoRegistrado }) {
      ...
      <div className="bg-gray-900 w-full h-[100dvh] md:h-auto md:max-w-3xl md:rounded-lg flex flex-col">
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          ...
          <div className="flex gap-2">
            <button onClick={() => setShowPago(true)} className="bg-green-600 hover:bg-green-700 px-3 py-1 rounded text-sm">
              Registrar pago
            </button>
            <button onClick={() => exportarPDFOrden({ elementId: "cc-pdf", filename: `CuentaCorriente-${cliente.nombre}.pdf` })}
