...
export default function NuevaOrden() {
    ...
    const loading =
        loadingClientes || loadingTipos || loadingItems || loadingProductos;
    ...
    return (
        <MainLayout>
            ...
            <ItemsSection
                ...
                productosDisponibles={productos} // 👈 nuevo
                loading={loading}
            ...
            <Modal
                ...
                actions={
                    <>
                        <button
                            onClick={() =>
                                navigate(`/ordenes/${ordenIdCreada}`)
                            }
            ...
            >
                La orden se guardó en el sistema. Podés cargar otra o seguir
                trabajando.
            </Modal>
        </MainLayout>
    );
