...
export default function Dashboard() {
  ...
  const ordenesConDeuda = ordenes.filter((o) => Number(o.saldo) > 0).length; const ordenesPagadas = ordenes.filter( (o) => Number(o.saldo) === 0 && Number(o.total) > 0 ).length;
